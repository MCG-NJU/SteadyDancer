...
- **2025-12-12**: 🔥 Added example workflow [wanvideo_SteadyDancer_example_04.json](workflows/) for multi-person video generation in ComfyUI using SteadyDancer with a multi-person pose detector from [comfyui_controlnet_aux](https://github.com/Fannovel16/comfyui_controlnet_aux) to support **multi-person** video generation.
- **2025-12-11**: 🔥 Provide a new workflow [wanvideo_SteadyDancer_example_03.json](workflows/) for [ComfyUI-WanVideoWrapper](https://github.com/kijai/ComfyUI-WanVideoWrapper), which inserted an **alignment-enabled** pose detector from [ComfyUI-WanAnimatePreprocess](https://github.com/kijai/ComfyUI-WanAnimatePreprocess), **without the installation of open mmpose** in ComfyUI.
